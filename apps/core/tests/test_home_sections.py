...
class HomeSectionLayoutTests(TestCase):
    ...
    def test_delivery_grid_sits_below_fabrication_with_rundown_and_skyline(self, _localdate):
        ...
        self.assertIn("full 60-day lookahead below, classified at 03 Sep 26", html)
        self.assertIn("607 spools · 48 performed / 559 upcoming", html)
        self.assertIn("<span>Forecast</span><span></span><span>Lookahead</span>", html)
        self.assertIn("Forecast · baseline", html)
        ...
        self.assertIn("Weekly baseline forecast and full 60-day lookahead skyline with all scheduled lines visible", html)
        ...
        self.assertIn("Number(week.lookahead_total || 0) > 0", html)
