...
from apps.core import fabrication_source, rundown_source, skyline_source, tracking_source
...
def home_view(request):
    ...
    # A skyline combina a baseline da Planilha1 com o lookahead do Runddown e
